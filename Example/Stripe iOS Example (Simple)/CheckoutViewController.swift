...
class CheckoutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let backendBaseURL: String? = "https://example-ios-backend.herokuapp.com"
    ...
    override func viewDidLoad() {
        ...
        self.paymentRow.onTap = { [weak self] _ in
            ...
            let vc = STPAddSourceViewController(configuration: strongSelf.paymentContext.configuration, theme: strongSelf.theme)
